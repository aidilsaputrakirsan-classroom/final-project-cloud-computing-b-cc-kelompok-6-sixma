        ...
        <div class="navbar-header">
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="d-none d-md-block ms-2">
                    <h5 class="mb-0 fw-semibold">Administrator Panel</h5>
                </div>
            </div>
                ...
                <div class="dropdown topbar-item">
                    <a type="button" class="topbar-button" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            {{-- Ganti dengan foto admin dinamis nanti --}}
                            <img class="rounded-circle" width="32" src="/images/users/avatar-1.jpg" alt="Admin Avatar">
                        </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        {{-- Tombol Logout (Sesuaikan route logout Anda) --}}

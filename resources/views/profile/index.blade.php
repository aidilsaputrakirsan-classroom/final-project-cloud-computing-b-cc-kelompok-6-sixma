            ...
            @if (!empty($images) && is_countable($images) && count($images) > 0)
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    @foreach ($images as $image)
                        <div
                            class="relative group overflow-hidden rounded-lg bg-gray-900 border border-gray-800 hover:border-yellow-400 transition">
                            ...
                            <div class="p-4">
                                ...
                                <div class="mt-3 flex justify-between items-center">
                                    ...
                                    <form action="{{ route('images.destroy', $image['id']) }}" method="POST"
                                        ...
                                        @method('DELETE')
                                        <button type="submit"
                                            class="text-xs px-3 py-1 bg-red-600 text-white rounded hover:bg-red-700 font-semibold">
                                            Delete
                                        </button>
                                    </form>

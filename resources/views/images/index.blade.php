            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                <div class="relative group overflow-hidden rounded-lg bg-gray-900 border border-gray-800 hover:border-yellow-400 transition">
                    ...
                    <div class="p-4">
                        ...
                        <div class="mt-3 flex justify-between items-center">
                            {{-- PERBAIKAN LINK VIEW: Gunakan ID placeholder 1 --}}
                            <a href="{{ route('images.show', ['id' => 1]) }}" class="text-xs px-3 py-1 bg-gray-700 text-white rounded hover:bg-gray-600 font-semibold">
                                View
                            </a>
                ...
                <div class="relative group overflow-hidden rounded-lg bg-gray-900 border border-gray-800 hover:border-yellow-400 transition">
                    ...
                    <div class="p-4">
                        ...
                        <div class="mt-3 flex justify-between items-center">
                            {{-- PERBAIKAN LINK VIEW: Gunakan ID placeholder 2 --}}
                            <a href="{{ route('images.show', ['id' => 2]) }}" class="text-xs px-3 py-1 bg-gray-700 text-white rounded hover:bg-gray-600 font-semibold">
                                View
                            </a>
                            <button type="button" class="text-gray-400 hover:text-red-500 transition">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="relative group overflow-hidden rounded-lg bg-gray-900 border border-gray-800 hover:border-yellow-400 transition">
                    ...
                    <div class="p-4">
                        ...
                        <div class="mt-3 flex justify-between items-center">
                            {{-- PERBAIKAN LINK VIEW: Gunakan ID placeholder 3 --}}
                            <a href="{{ route('images.show', ['id' => 3]) }}" class="text-xs px-3 py-1 bg-gray-700 text-white rounded hover:bg-gray-600 font-semibold">
                                View
                            </a>
                            <button type="button" class="text-gray-400 hover:text-red-500 transition">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="relative group overflow-hidden rounded-lg bg-gray-900 border border-gray-800 hover:border-yellow-400 transition">
                    ...
                    <div class="p-4">
                        ...
                        <div class="mt-3 flex justify-between items-center">
                            {{-- PERBAIKAN LINK VIEW: Gunakan ID placeholder 4 --}}
                            <a href="{{ route('images.show', ['id' => 4]) }}" class="text-xs px-3 py-1 bg-gray-700 text-white rounded hover:bg-gray-600 font-semibold">
                                View
                            </a>
                            <button type="button" class="text-gray-400 hover:text-red-500 transition">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
